...
#endif /* NR_GF_GNB_DEFS_H */

// NR_list_t is a "list" (of users, HARQ processes, slices, ...).
typedef struct {
  int head;
  int *next;
  int tail;
...
/* gNB template for the Random access information */
typedef struct {
...
/* scheduling control information set through an API */
...
/* UE list used by gNB to order UEs/CC for scheduling*/
typedef struct {
  rnti_t rnti;
...
typedef struct gNB_MAC_INST_s {
  ...
  /// a PDCCH PDU groups DCIs per BWP and CORESET.
